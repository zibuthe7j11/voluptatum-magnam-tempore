...
[![Coverage Status](https://coveralls.io/repos/github/zibuthe7j11/voluptatum-magnam-tempore/badge.svg)](https://coveralls.io/github/zibuthe7j11/voluptatum-magnam-tempore)
[![ci](https://github.com/zibuthe7j11/voluptatum-magnam-tempore/actions/workflows/ci.yml/badge.svg)](https://github.com/zibuthe7j11/voluptatum-magnam-tempore/actions/workflows/ci.yml)
[![NPM Version](https://img.shields.io/npm/v/@zibuthe7j11/voluptatum-magnam-tempore.svg)](https://www.npmjs.com/package/@zibuthe7j11/voluptatum-magnam-tempore)
[![NPM Downloads](https://img.shields.io/npm/dm/@zibuthe7j11/voluptatum-magnam-tempore.svg)](http://npm-stat.com/charts.html?package=@zibuthe7j11/voluptatum-magnam-tempore)
[![jsDelivr hits (npm)](https://img.shields.io/jsdelivr/npm/hw/@zibuthe7j11/voluptatum-magnam-tempore)](https://www.jsdelivr.com/package/npm/@zibuthe7j11/voluptatum-magnam-tempore)
...
```
npm install @zibuthe7j11/voluptatum-magnam-tempore
```
...
import { supportTransform } from "@zibuthe7j11/voluptatum-magnam-tempore";
...
```js
// EXAMPLES
import { getAttribute, hasAttribute, setAttribute } from "@zibuthe7j11/voluptatum-magnam-tempore";
...
```js
// EXAMPLES
import { support3DTransform } from "@zibuthe7j11/voluptatum-magnam-tempore";
...
```js
// EXAMPLES
import { addClass, removeClass, hasClass } from "@zibuthe7j11/voluptatum-magnam-tempore";
...
```js
// EXAMPLES
import { on, off, one, passiveHandler } from "@zibuthe7j11/voluptatum-magnam-tempore";
...
```js
// EXAMPLES
import { getElementAnimationDuration } from "@zibuthe7j11/voluptatum-magnam-tempore";
...
```js
// EXAMPLES
import { isArray, isHTMLElement, isElementsArray } from "@zibuthe7j11/voluptatum-magnam-tempore";
...
The **_Data_** and **_Timer_** utilities have their own specifics, you might want to check the [wiki](https://github.com/zibuthe7j11/voluptatum-magnam-tempore/wiki).

```js
// EXAMPLES
import { emulateTransitionEnd, distinct } from "@zibuthe7j11/voluptatum-magnam-tempore";
...
```js
// EXAMPLES
import { querySelector, querySelectorAll, documentAll, matches } from "@zibuthe7j11/voluptatum-magnam-tempore";
...
```js
// EXAMPLES
import { on, off, one, mouseClickEvents, touchEvents, passiveHandler } from "@zibuthe7j11/voluptatum-magnam-tempore";
...
```js
// Example
import on from "@zibuthe7j11/voluptatum-magnam-tempore/src/event/on";
import addClass from "@zibuthe7j11/voluptatum-magnam-tempore/src/class/addClass";
import getElementById from "@zibuthe7j11/voluptatum-magnam-tempore/src/selectors/getElementById";
import mouseclickEvent from "@zibuthe7j11/voluptatum-magnam-tempore/src/strings/mouseclickEvent";
...
**shorty** is released under the [MIT License](https://github.com/zibuthe7j11/voluptatum-magnam-tempore/blob/master/LICENSE)
